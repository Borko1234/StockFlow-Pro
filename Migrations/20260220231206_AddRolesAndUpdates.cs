...
{
    /// <inheritdoc />
    public partial class AddRolesAndUpdates : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScannedByEmployeeId = table.Column<int>(type: "INTEGER", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderProcessings_Employees_CreatedByEmployeeId",
                        column: x => x.CreatedByEmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OrderProcessings_Employees_PreparedByEmployeeId",
                        column: x => x.PreparedByEmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OrderProcessings_Employees_ScannedByEmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderProcessings_CreatedByEmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderProcessings_PreparedByEmployeeId",
                table: "OrderProcessings",
                column: "PreparedByEmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderProcessings_ScannedByEmployeeId",
                table: "OrderProcessings",
